...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  sysParam="false">  
  <span component="$UI/chat/funcsDialog/funcsDialog" xid="funcsDialog" forceRefreshOnOpen="true" mode="selectFunc" onReceive="funcsDialogReceive" filter='$model.labelStr.get().indexOf($row.val("fTitle")) == -1'/>
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1"><div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" title="我的应用">
   <div class="x-titlebar-left" xid="left1"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label="button" xid="backBtn" icon="glyphicon glyphicon-menu-left" onClick='{"operation":"window.close"}'>
   <i xid="i4" class="glyphicon glyphicon-menu-left"></i>
   <span xid="span4"></span></a></div>
   <div class="x-titlebar-title" xid="title1">我的应用</div>
   <div class="x-titlebar-right reverse" xid="right1"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label="sureBtn" xid="button4" icon="linear linear-bubble" onClick="button4Click">
   <i xid="i5" class="linear linear-bubble"></i>
   <span xid="span5">sureBtn</span></a></div></div></div><div class="x-panel-content" xid="content1"> 
      <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
        xid="panel2"> 
                    ...
                    <div bind-if="val('fIsFunc')" bind-css="{media:val('fIsFunc'),'x-currentRow':$object===$model.funcsData.getCurrentRow()}"> 
                      <div class="pull-left x-func-checkbox" bind-if="'selectFunc'===$model.mode.get()"> 
                        <span component="$UI/system/components/justep/button/checkbox"
                          class="x-checkbox" bind-ref="ref('selected')" xid="check"/> 
                      </div>  
