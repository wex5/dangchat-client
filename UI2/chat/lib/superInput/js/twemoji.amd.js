      ...
      while (length--) {
        ...
        while ((match = re.exec(text))) {
          ...
          if (src) {
            ...
            img.className = img.className + options.className + " x-superinput-emoji-sprite x-superinput-sprite-" + iconId;
            img.setAttribute('image-alt',rawText);
            img.setAttribute('image-src',src);
            modified = true;
